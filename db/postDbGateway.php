<?
    ...
    class PostDbGateway{
        ...
        function getRecentPosts() {
            $getRecentPostsQuery = "select users.username, posts.poster_id, posts.post_id, posts.post_content, posts.number_comments from users inner join posts on users.user_id = posts.poster_id and delete_bit = 0 order by post_id desc limit 5;";
        ...
        function createPost($userId, $postText) {
            ...
            $createPostQuery = "insert into posts VALUES(" . $userId . ", NULL, '" . $textToStore . "', 0, 0);";
        ...
        function doesPostExist($postId) {
            $postExistQuery = "select * from posts where post_id=" . $postId . " and delete_bit = 0;";
